...
<!-- FORM: HEAD SECTION -->
    ...
    <link href="https://www.tfaforms.com/form-builder/4.3.0/css/wforms-layout.css?v=512-8" rel="stylesheet" type="text/css" />
    ...
    <link href="https://www.tfaforms.com/form-builder/4.3.0/css/wforms-jsonly.css?v=512-8" rel="alternate stylesheet" title="This stylesheet activated by javascript" type="text/css" />
    <script type="text/javascript" src="https://www.tfaforms.com/wForms/3.10/js/wforms.js?v=512-8"></script>
    <script type="text/javascript">
        wFORMS.behaviors.prefill.skip = false;
    </script>
        <script type="text/javascript" src="https://www.tfaforms.com/wForms/3.10/js/localization-en_US.js?v=512-8"></script>
...
<h3 class="wFormTitle" id="tfa_0-T">2019 SWT Appointment Request - Schedule F</h3>
...
<label id="tfa_Contactnumber-L" for="tfa_Contactnumber" class="label preField reqMark">Mobile Phone number</label><br><div class="inputWrapper"><input type="text" id="tfa_Contactnumber" name="tfa_Contactnumber" value="" placeholder="" title="Mobile Phone number" class="required"></div>
</div>
...
<label id="tfa_CourseofStudy-L" for="tfa_CourseofStudy" class="label preField reqMark">Course of Study</label><br><div class="inputWrapper"><input type="text" id="tfa_CourseofStudy" name="tfa_CourseofStudy" value="" placeholder="" title="Course of Study" class="required"></div>
</div>
...
<label id="tfa_SummerWorkRegist-L" for="tfa_SummerWorkRegist" class="label preField reqMark">Summer Work Registration Number</label><br><div class="inputWrapper">
<input type="text" id="tfa_SummerWorkRegist" name="tfa_SummerWorkRegist" value="" placeholder="" maxlength="8" title="Summer Work Registration Number" class="validate-alphanum required"><span class="field-hint-inactive" id="tfa_SummerWorkRegist-H"><span id="tfa_SummerWorkRegist-HH" class="hint">You must input your registration number correctly otherwise your appointment request will not be approved.</span></span>
</div>
</div>
</fieldset>
<div class="oneField field-container-D     " id="tfa_Anyambiguityorte-D">
<label id="tfa_Anyambiguityorte-L" for="tfa_Anyambiguityorte" class="label preField reqMark">Are you are REHIRE?</label><br><div class="inputWrapper"><select id="tfa_Anyambiguityorte" name="tfa_Anyambiguityorte" title="Are you are REHIRE?" class="required"><option value="">Please select...</option>
...
<label id="tfa_Whatisyourpresen-L" for="tfa_Whatisyourpresen" class="label preField ">If YES to the question above, who was your previous employer?</label><br><div class="inputWrapper"><input type="text" id="tfa_Whatisyourpresen" name="tfa_Whatisyourpresen" value="" placeholder="" title="If YES to the question above, who was your previous employer?" class=""></div>
</div>
<div class="oneField field-container-D     " id="tfa_DesiredAppointme-D">
<label id="tfa_DesiredAppointme-L" for="tfa_DesiredAppointme" class="label preField reqMark">Desired Appointment Date</label><br><div class="inputWrapper"><select id="tfa_DesiredAppointme" name="tfa_DesiredAppointme" title="Desired Appointment Date" class="required"><option value="">Please select...</option>
</select></div>
</div>
<div class="htmlSection" id="tfa_1"><div class="htmlContent" id="tfa_1-HTML"><div id="html-tmp-2993913426430" class="htmlsection">
<p><em>Please note that by submitting this request for appointment, you hereby agree that the information you are supplying is factual and true to the best of your knowledge, you will be available for program processing on the scheduled date and understand that failure to show up for processing will result in the cancellation of your application package. This schedule portal is only valid for 72 hours from the date and time you receive the request notification by email. Besor Associates reserves the right to grant or decline your request based on prevailing factors, appointment and job slots availability. Please, note that your application package will not be activated until you schedule an appointment to process. If your appointment scheduling is successful, you will receive an official acceptance email confirming your appointment. Thank you.</em></p>
</div>
...
<input type="hidden" value="4706219" name="tfa_dbFormId" id="tfa_dbFormId"><input type="hidden" value="" name="tfa_dbResponseId" id="tfa_dbResponseId"><input type="hidden" value="247904af667cdce38e7f0ad911697474" name="tfa_dbControl" id="tfa_dbControl"><input type="hidden" value="2" name="tfa_dbVersionId" id="tfa_dbVersionId"><input type="hidden" value="" name="tfa_switchedoff" id="tfa_switchedoff">
</form>
</div></div>
