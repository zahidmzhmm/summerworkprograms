    ...
    <tr>
        <td align="center" class="mainbody">
            <table cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="80%" class="log-in-container" valign="top">
                        <form name="admin" method="post" enctype="multipart/form-data" action="checklogin.php"
                              onSubmit="jacascript: return check();">
                            <table width="24%" class="log-in-box" align="center" cellpadding="5" cellspacing="0">
                                ...
                                <tr>
                                    <td colspan="2" align="center">
                                        <center><input type="submit" class="btnStyle" value="Log In"/></center>
                                    </td>
                                </tr>
                            </table>
                        </form>
