...
<table width="100%">
    ...
    <tr>
        <td colspan="3" align="left">
            <form name="new_cat" action="home.php?modules=users&action=participant_statement_save&id=<?= $id; ?>&pg=<?=@$_REQUEST["pg"]?>" method="post"
...
<tr>
    ...
    <select name="participant_statement_link" id="participant_statement_link">
      <option value="close" <?=$participant_statement_link=="close"?"selected":""?>>CLOSE</option>
      <option value="open" <?=$participant_statement_link=="open"?"selected":""?>>OPEN</option>
    </select>
    </td>
</tr>
                    <tr>
