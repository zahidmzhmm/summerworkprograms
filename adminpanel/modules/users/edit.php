...
<table width="100%">
  ...
  <tr>
    <td colspan="3" align="left"><form name="user" action="home.php?modules=users&action=post&id=<?= $id;?>" method="post" enctype="multipart/form-data">
        <table width="100%" cellpadding="3" cellspacing="0">
          <tr>
            ...
            <td width="85%" align="left"><span class="form_field">
              <select name="gender"  class="txt_field_1" >
                ...
                <option value="female"<?if($user_data['gender']=='female'){?>selected="selected"<?}?>>Female</option>
              </select>
            </span></td>
          </tr>
          <tr>
            <td align="left">First Name </td>
            <td align="left"><input type="text" name="firstname" size="40" value="<?= $user_data['firstname'];?>" /></td>
          </tr>
          <tr>
            <td align="left">Last Name </td>
            <td align="left"><input type="text" name="lastname" size="40" value="<?= $user_data['lastname'];?>" /></td>
          </tr>
          <tr>
            <td align="left">Email</td>
            <td align="left"><input type="text" name="email" size="40" value="<?= $user_data['email'];?>" /></td>
          </tr>
           <tr>
            ...
            <td align="left"><span class="form_field">
              <select name="month_dob" id="month_dob"  >
                ...
                <option value="March" <?if($user_data['dob_month']=='March'){?>selected="selected"<?}?>>March</option>
                <option value="April" <?if($user_data['dob_month']=='April'){?>selected="selected"<?}?>>April</option>
                <option value="May" <?if($user_data['dob_month']=='May'){?>selected="selected"<?}?>>May</option>
                <option value="June" <?if($user_data['dob_month']=='June'){?>selected="selected"<?}?>>June</option>
                <option value="July" <?if($user_data['dob_month']=='July'){?>selected="selected"<?}?>>July</option>
                <option value="August" <?if($user_data['dob_month']=='August'){?>selected="selected"<?}?>>August</option>
          ...
          <tr>
            ...
            <td align="left"><input type="text" name="age" size="40" value="<?= $user_data['age'];?>" /></td>
          </tr>
          <tr>
            <td align="left">Gender</td>
            <td align="left"><input type="text" name="gender" size="40" value="<?= $user_data['gender'];?>" /></td>
          </tr>
          <tr>
            <td align="left">Place of Birth</td>
            <td align="left">
	<input type="text" name="birth_country " size="40" value="<?= $user_data['birth_country '];?>" /></td>
          </tr>
          <tr>
            <td align="left">Date of Birth </td>
            <td align="left"><span class="form_field">
          ...
          <tr>
            ...
            <td align="left"><input type="password" name="password" size="20" value="<?= $user_data['password'];?>" maxlength="20" /></td>
          </tr>
          <tr>
            <td align="left">&nbsp;</td>
