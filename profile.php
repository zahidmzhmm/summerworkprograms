        ...
        <div class="block-content form inline-label">
            <fieldset class="grey-bg">
                ...
                <p>
                    ...
                    <a href="javascript:void(0)" onclick="openModal()" data-toggle="modal" data-target="#myModal" id="myBtn">Schedule</a>
                <p>
...
<div id="myModal" class="modal">
  ...
  <div class="modal-content">
    ...
    <?php if($member->appointment_status == "close") { ?>
      <div style="font-size: 1.25em;padding-top: 15px;padding-bottom: 15px;">Appointment is Closed. You will receive notification when appointment is open for your schedule group.</div>
    <?php } else if($member->appointment_status == "declined"){?>
			<div style="font-size: 1.25em;padding-top: 15px;padding-bottom: 15px;">Appointment request has been Declined. The office will open new dates when available.</div>
		<?php }
    ...
    ?>
      <div style="font-size: 1.25em;padding-top: 15px;padding-bottom: 15px;">
        ...
        <div><b>Appointment Approval Status:</b> <?php
         if($member->appointment_approve_status == "approve"){?>Approved<?php } else if($member->appointment_approve_status == "declined"){ echo 'Appointment has been Declined. The office will open new dates when available';} else {?>Pending<?php }?></div><br>
            ...
            <div class="form-group form-inline">
                <label class="text-left" style="padding-right: 5px">Appointment Date / Time<?=$member->appointment_date_time;?></label>
                  <select class="form-control" name="appointment_date_time" id="appointment_date_time">
    ...
    <?php } }
        ...
        <div style="font-size: 1.25em;padding-top: 15px;padding-bottom: 15px;">
            <div><b>Appointment Approval Status:</b> <?php
         if($member->appointment_approve_status == "approve"){?>Approved<?php } else if($member->appointment_approve_status == "declined"){ echo 'Appointment request has been Declined. The office will open new dates when available.';} else{?>Pending<?php }?></div><br>
				 <?php if($member->appointment_approve_status != "declined"){?>
         <div><b>Appointment Type:</b> <?php if($member->appointment_type=='onsite'){ echo 'In-person (Onsite)';} else { echo 'Virtual (Online)';}?></div><br>
