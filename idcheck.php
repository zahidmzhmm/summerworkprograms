...
<link href="https://www.tfaforms.com/form-builder/4.3.0/css/wforms-layout.css?v=4616-5" rel="stylesheet"
      type="text/css"/>
<!--[if IE 8]>
...
<link href="https://www.tfaforms.com/form-builder/4.3.0/css/wforms-jsonly.css?v=4616-5" rel="alternate stylesheet"
    ...
    <div class="">
        <div class="wForm" id="tfa_0-WRPR" dir="ltr">
            ...
            <form method="post" action="https://www.tfaforms.com/responses/processor" class="hintsTooltip labelsAbove"
                  id="tfa_0" enctype="multipart/form-data">
                <fieldset id="tfa_Yourpersonaldeta" class="section required">
                    ...
                    <div class="oneField field-container-D     " id="tfa_Contactnumber-D">
                        ...
                        <div class="inputWrapper"><input type="text" id="tfa_Contactnumber" name="tfa_Contactnumber"
                                                         value="" placeholder="" title="Phone number" class="required">
                        </div>
                    </div>
                ...
                <div class="oneField field-container-D     " id="tfa_Whatisyourpresen-D">
                    <label id="tfa_Whatisyourpresen-L" for="tfa_Whatisyourpresen" class="label preField ">Name of
                        Employer scheduled for interview?</label><br>
                    <div class="inputWrapper"><input type="text" id="tfa_Whatisyourpresen" name="tfa_Whatisyourpresen"
                                                     value="" placeholder=""
                                                     title="Name of Employer scheduled for interview?" class=""></div>
                </div>
                <div class="oneField field-container-D    hintsTooltip " id="tfa_DesiredAppointme-D">
                    <label id="tfa_DesiredAppointme-L" for="tfa_DesiredAppointme" class="label preField reqMark">Interview
                        Smiley Picture</label><br>
                    <div class="inputWrapper">
                        <input type="file" id="tfa_DesiredAppointme" name="tfa_DesiredAppointme" size=""
                               title="Interview Smiley Picture" class="required"><span class="field-hint-inactive"
                                                                                       id="tfa_DesiredAppointme-H"><span
                                    id="tfa_DesiredAppointme-HH" class="hint">Upload a Smiley Picture.</span></span>
                    </div>
                </div>
                <div class="htmlSection" id="tfa_1">
                    <div class="htmlContent" id="tfa_1-HTML"><p><em>Please <b>DO NOT</b> upload any form of
                                unprofessional pictures downloaded from your social media with image effects or other
                                distracting features. Kindly review samples of acceptable smiley pictures at <a
                                        href="http://www.summerworkprograms.com/smiley.pdf" target="_blank">www.summerworkprograms.com/smiley</a>.
                                Thank you. <br></em></p></div>
                </div>
                <div>
                ...
                <input type="hidden" value="4660811" name="tfa_dbFormId" id="tfa_dbFormId"><input type="hidden" value=""
                                                                                                  name="tfa_dbResponseId"
                                                                                                  id="tfa_dbResponseId"><input
                        type="hidden" value="d2324a1e62d9d53a97bb161d0a7e0224" name="tfa_dbControl"
                        id="tfa_dbControl"><input type="hidden" value="2" name="tfa_dbVersionId"
