...
?>
<style>
    #recaptcha_response_field{height: 24px;}
    #recaptcha_privacy{ margin-top:-10px;}
</style>
	...
	<div class="container-fluid col-padding-0">
		<div class="row">
			<div class="col-sm-12 col-md-6 col-lg-6">
				<div class="contact__banner align-v-h bg-overlay" style="background-image: url(&quot;assets/images/banners/5.jpg&quot;); background-size: cover; background-position: center center;">
					...
					<div class="row">
							<div class="col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<input type="text" name="name"  id="name" class="form-control form-poshytip" title="Enter your full name" placeholder="Name">
								</div>
							</div><!-- /.col-lg-6 -->
							<div class="col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<input type="email" name="email" id="email" type="email" class="form-poshytip form-control" title="Enter your email address" placeholder="Email">
								</div>
							</div><!-- /.col-lg-6 -->
						</div><!-- /.row -->
						<div class="row">
							<div class="col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<input name="phone"  id="phone" type="text" class="form-poshytip form-control" title="Enter your phone" placeholder="Phone">
								</div>
							</div><!-- /.col-lg-6 -->
							<div class="col-sm-6 col-md-6 col-lg-6">
								<div class="form-group">
									<input type="text" name="subject" id="subject" class="form-poshytip form-control" title="Enter subject" placeholder="Subject">
								</div>
							</div><!-- /.col-lg-6 -->
						</div><!-- /.row -->
						<div class="row">
							<div class="col-sm-12 col-md-12 col-lg-12">
								<div class="form-group mb-30"><textarea name="message" id="message" class="form-poshytip form-control" title="Enter message" placeholder="Message"></textarea></div>
							</div><!-- /.col-lg-12 -->
						</div><!-- /.row -->
						<div class="row">
							...
							<div class="col-sm-12 col-md-12 col-lg-12">
								<button style="background-image:none" type="button" id="submit" class="btn btn__rounded btn__primary btn__hover3">Send Message</button>
							</div><!-- /.col-lg-12 -->
						</div><!-- /.row -->
					</form>
				</div>
