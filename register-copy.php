...
<div class="form-group">
	...
	<div class="previews col-6" id="previews">
		...
		<div id="previewBig2" class="previewBig">
			...
			//	$img	=	"user_uploads/$user_id/pp_photo.jpg";
				echo '<img id="old_preview" style="width: 111.34px;height: 110.722px;" src="'.$img.'">';
			} else {
				echo '<img id="old_preview" style="width: 111.34px;height: 110.722px;" src="img/mono-icons/user32.png">';
			}
			?>
		</div>
	</div>
...
<div class="col-md-6"></div>
                ...
                <div id="step-6">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="checkbox" value="1" name="chk_consent_agree"> <label for="chk_consent_agree"> Yes,
                            I agree.</label>
...
<script type="text/javascript">
				...
				$(function(){
					...
					$('#apply').on("click",function(){
                        if(widthImage >300 || heightImage >300){
                            swal('You must crop image between 300*300');
                            return;
                        }
                        $('#imageModel').modal('hide');
						$('#previewBig2 #old_preview').remove();
						cropImage($('#previewBig2 img').attr("src"));
						$("#previews").show();
					});
    ...
    function onFinishCallback() {
        ...
        if ($("input[name='chk_consent_agree']").attr("checked") == "checked") {
