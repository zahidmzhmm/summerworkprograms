    ...
    <section class="grid">
        <div class="block-border">
            ...
            <div class="form block-content">
                ...
                <p> If your review is successful, you will receive an email notice to schedule an appointment for the application processing and once your appointment request is approved, you will receive another confirmation email from the Program Administrator containing details of your status and scheduled appointment.</p>
                <p>You are hereby required to upload a clear scanned copy of your student ID Card, Admission Letter, Biodata page of International passport and your Academic Record within 24 hours of this registration to enable us complete the review of your registration.</p>
                <p> If these documents are not uploaded within the stipulated period, your registration may be cancelled and further access to the portal restricted. </p>
                <p>Please, note that you will be required to bring the printed copy of your submitted registration form, duly signed by you and your parent to our office when scheduled to process your application package with the following documents:</p>
