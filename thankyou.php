...
if ($_POST) {
    ...
    $input_data = [
        ...
        'work_address_father' => @$_POST['work_address_father'],
        'nid_father' => @$_POST['nid_father'],
        'home_address_mother' => @$_POST['home_address_mother'],
        'work_address_mother' => @$_POST['work_address_mother'],
        'nid_mother' => @$_POST['nid_mother'],
        'skype_id' => @$_POST['skype_id'],
        'social_media_handles' => @$_POST['social_media_handles'],
        'social_media_handles_val' => @$_POST['social_media_handles_val'],
        'linkedin_profile' => @$_POST['linkedin_profile'],
        'whatsapp_number' => @$_POST['whatsapp_number'],
        'home_address_sponsor' => @$_POST['home_address_sponsor'],
        'work_address_sponsor' => @$_POST['work_address_sponsor'],
        'nid_sponsor' => @$_POST['nid_sponsor'],
        'num_dependents_sponsor' => @$_POST['num_dependents_sponsor'],
        'members_participated' => @$_POST['members_participated'],
        'members_participated_student' => @$_POST['members_participated_student'],
        'members_participated_relationship' => @$_POST['members_participated_relationship'],
        'members_participated_institution' => @$_POST['members_participated_institution'],
        'members_participated_yes' => @$_POST['members_participated_yes'],
        'members_participated_p_sponsor' => @$_POST['members_participated_p_sponsor'],
        'members_participated_local_representative' => @$_POST['members_participated_local_representative'],
        'members_participated_employer' => @$_POST['members_participated_employer'],
        'members_participated_em_location' => @$_POST['members_participated_em_location'],
        'occupation_usa' => @$_POST['occupation_usa'],
        'duration_stay_usa' => @$_POST['duration_stay_usa']
    ];
