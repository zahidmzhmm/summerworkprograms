...
<!-- FORM: HEAD SECTION -->
    ...
    <link href="https://www.tfaforms.com/form-builder/4.3.0/css/wforms-layout.css?v=512-10" rel="stylesheet" type="text/css" />
    ...
    <link href="https://www.tfaforms.com/form-builder/4.3.0/css/wforms-jsonly.css?v=512-10" rel="alternate stylesheet" title="This stylesheet activated by javascript" type="text/css" />
...
<option value="tfa_48" id="tfa_48" class="">December 20, 2018 - 10:00am</option></select></div>
</div>
...
<input type="hidden" value="4706877" name="tfa_dbFormId" id="tfa_dbFormId"><input type="hidden" value="" name="tfa_dbResponseId" id="tfa_dbResponseId"><input type="hidden" value="b826932a45cfa68a1c389cd9eea348c2" name="tfa_dbControl" id="tfa_dbControl"><input type="hidden" value="1" name="tfa_dbVersionId" id="tfa_dbVersionId"><input type="hidden" value="" name="tfa_switchedoff" id="tfa_switchedoff">
</form>
</div></div>
