...
<section class="grid">
    <div class="block-border">
        ...
        <div class="block-content">
            ...
            Your unique registration number is <?php echo ucwords($member_data['referenceid']); ?> and your application
            is pending activation while the registration will be carefully reviewed within the next 24 hours. <br/><br/>
            If successful, you will receive a confirmation email from the Program Administrator containing details of
            your status and a scheduled appointment for the application processing.<br/><br/>
            You will be required to upload a clear scanned copy of your student ID Card, Admission Letter and passport
            sized photograph within 24 hours of this registration to enable us complete the review of your
            registration.If these documents are not uploaded within the stipulated period, your registration may be
            cancelled and further access to the portal restricted.<br/><br/>
            Please, also note that you are expected to bring the printed copy of your submitted registration form, duly
            signed by you and your parent to our office within the stipulated period to process your application package
            with the following documents:<br/><br/>
            - Administrative Fee payment teller<br/>
            - 4 passport sized photographs<br/>
            - Signed parental consent letter<br/>
            - Photocopy of International Passport<br/>
