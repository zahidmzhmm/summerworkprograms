				...
				<div id="menu-holder">
					...
					<div class="wrapper">
						...
						<ul id="nav" class="sf-menu">
							...
							<li><?php if($_SESSION['user_id']){?><a href="profile.php">Profile<span class="subheader">Access your Profile</span></a><?php }else { ?> <a href="login.php">Check Status<span class="subheader">Access your Profile</span></a><?php } ?></li>
                            <?php if(!$_SESSION['user_id']){?>
						 	<li><a href="user-register.php">Register<span class="subheader">Participate Now</span></a></li><? } ?>
                            ...
                            <?php if($_SESSION['user_id']){?><li><a href="logout.php">Logout<span class="subheader">Sign Out</span></a></li><?php } ?>
						</ul>
						<!-- Navigation -->
					</div>
					<!-- wrapper-menu -->
