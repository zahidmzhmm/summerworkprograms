                ...
                <tr>
                    <td>
                        <table width="100%" border="0" cellspacing="0" cellpadding="0">
                            <tr>
                                <td>
                                    <div id="banner"><img src="images/header.jpg" width="980" height="297"/></div>
                                </td>
                            </tr>
                        </table>
                    </td>
                                ...
                                <td>
                                    <div class="weltxt">
                                        <p><strong>Thank you !</strong><br/>
                                            ...
                                            Thank you for registering to participate in the Summer Work & Travel
                                            Program.<br/><br/>
                                            Your unique registration number
                                            is <?php echo ucwords($member_data['referenceid']); ?> and your application
                                            is pending activation while the registration will be carefully reviewed
                                            within the next 24 hours. <br/><br/>
                                            If successful, you will receive a confirmation email from the Program
                                            Administrator containing details of your status and a scheduled appointment
                                            for the application processing.<br/><br/>
                                            Please, note that you will be expected to bring the printed copy of your
                                            submitted registration form, duly signed by you and your parent to our
                                            office within the stipulated period to process your application package with
